  ...
  extends ScheduledThreadPoolExecutor
{
  ...
  private <T> Future<T> scheduleWithRetryInternal(Callable<T> paramCallable)
  {
    ...
    paramCallable = new RetryFuture(paramCallable, new RetryState(backoff, retryPolicy), this);
...
/* Location:
 * Qualified Name:     io.fabric.sdk.android.services.concurrency.internal.RetryThreadPoolExecutor
