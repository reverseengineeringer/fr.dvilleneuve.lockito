  ...
  implements SettingsSpiCall
{
  ...
  {
    return paramHttpRequest.header("X-CRASHLYTICS-API-KEY", apiKey).header("X-CRASHLYTICS-API-CLIENT-TYPE", "android").header("X-CRASHLYTICS-D", deviceId).header("X-CRASHLYTICS-API-CLIENT-VERSION", kit.getVersion()).header("Accept", "application/json");
  }
