...
public abstract class AbstractSpiCall
{
  ...
  {
    return requestFactory.buildHttpRequest(method, getUrl(), paramMap).useCaches(false).connectTimeout(10000).header("User-Agent", "Crashlytics Android SDK/" + kit.getVersion()).header("X-CRASHLYTICS-DEVELOPER-TOKEN", "bca6990fc3c15a8105800c0673517a4b579634a1");
  }
