  ...
  extends Fragment
{
  ...
  public void getMapAsync(OnMapReadyCallback paramOnMapReadyCallback)
  {
    ...
    ahi.getMapAsync(paramOnMapReadyCallback);
  }
  ...
  public final void onEnterAmbient(Bundle paramBundle)
  {
    ...
    ahi.onEnterAmbient(paramBundle);
  }
    ...
    extends zza<MapFragment.zza>
  {
    ...
    public void getMapAsync(OnMapReadyCallback paramOnMapReadyCallback)
    {
      if (zzbcr() != null)
      {
        ((MapFragment.zza)zzbcr()).getMapAsync(paramOnMapReadyCallback);
        return;
      }
    ...
    {
      if (zzbcr() != null) {
        ((MapFragment.zza)zzbcr()).onEnterAmbient(paramBundle);
      }
    }
    ...
    {
      if (zzbcr() != null) {
        ((MapFragment.zza)zzbcr()).onExitAmbient();
      }
    }
