  ...
  extends Fragment
{
  ...
  public final StreetViewPanorama getStreetViewPanorama()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((ahD == null) || (ahD.zzbpv().asBinder() != ((IStreetViewPanoramaDelegate)localObject).asBinder())) {
          ahD = new StreetViewPanorama((IStreetViewPanoramaDelegate)localObject);
        }
        return ahD;
      }
  ...
  public void getStreetViewPanoramaAsync(OnStreetViewPanoramaReadyCallback paramOnStreetViewPanoramaReadyCallback)
  {
    ...
    ahW.getStreetViewPanoramaAsync(paramOnStreetViewPanoramaReadyCallback);
  }
    ...
    extends zza<SupportStreetViewPanoramaFragment.zza>
  {
    ...
    public void getStreetViewPanoramaAsync(OnStreetViewPanoramaReadyCallback paramOnStreetViewPanoramaReadyCallback)
    {
      if (zzbcr() != null)
      {
        ((SupportStreetViewPanoramaFragment.zza)zzbcr()).getStreetViewPanoramaAsync(paramOnStreetViewPanoramaReadyCallback);
        return;
      }
