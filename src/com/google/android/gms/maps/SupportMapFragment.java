  ...
  extends Fragment
{
  ...
  public void getMapAsync(OnMapReadyCallback paramOnMapReadyCallback)
  {
    ...
    ahU.getMapAsync(paramOnMapReadyCallback);
  }
  ...
  public final void onEnterAmbient(Bundle paramBundle)
  {
    ...
    ahU.onEnterAmbient(paramBundle);
  }
    ...
    implements MapLifecycleDelegate
  {
    ...
    public void onEnterAmbient(Bundle paramBundle)
    {
      try
      {
        ahj.onEnterAmbient(paramBundle);
        return;
      }
      catch (RemoteException paramBundle)
      {
    ...
    extends zza<SupportMapFragment.zza>
  {
    ...
    public void getMapAsync(OnMapReadyCallback paramOnMapReadyCallback)
    {
      if (zzbcr() != null)
      {
        ((SupportMapFragment.zza)zzbcr()).getMapAsync(paramOnMapReadyCallback);
        return;
      }
    ...
    {
      if (zzbcr() != null) {
        ((SupportMapFragment.zza)zzbcr()).onEnterAmbient(paramBundle);
      }
    }
    ...
    {
      if (zzbcr() != null) {
        ((SupportMapFragment.zza)zzbcr()).onExitAmbient();
      }
    }
