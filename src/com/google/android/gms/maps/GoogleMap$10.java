...
class GoogleMap$10
  extends zzw.zza
{
  GoogleMap$10(GoogleMap paramGoogleMap, GoogleMap.OnPolylineClickListener paramOnPolylineClickListener) {}
  
  public void zza(IPolylineDelegate paramIPolylineDelegate)
  {
    agI.onPolylineClick(new Polyline(paramIPolylineDelegate));
  }
}
