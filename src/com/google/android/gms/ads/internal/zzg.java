...
public class zzg
{
  ...
  private static boolean zza(@Nullable zzka paramzzka)
  {
    if (paramzzka == null) {
      return true;
    }
  ...
  public void zza(final Context paramContext, final VersionInfoParcel paramVersionInfoParcel, final boolean paramBoolean, @Nullable zzka paramzzka, final String paramString1, @Nullable final String paramString2)
  {
    if (!zza(paramzzka)) {
      return;
    }
