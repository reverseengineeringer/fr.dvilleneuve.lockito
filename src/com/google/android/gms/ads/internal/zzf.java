  ...
  implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener
{
  ...
  private boolean zzb(@Nullable zzjy paramzzjy1, zzjy paramzzjy2)
  {
    View localView1;
    if (zzccc)
    {
  ...
  protected zzll zza(zzjy.zza paramzza, @Nullable zze paramzze, @Nullable zzjs paramzzjs)
  {
  ...
  protected void zza(@Nullable zzjy paramzzjy, boolean paramBoolean)
  {
  ...
  public boolean zza(@Nullable zzjy paramzzjy1, zzjy paramzzjy2)
  {
  ...
  void zze(@Nullable zzjy paramzzjy)
  {
    if (paramzzjy == null) {}
