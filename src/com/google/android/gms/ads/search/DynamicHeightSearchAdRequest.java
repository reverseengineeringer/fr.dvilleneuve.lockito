...
public final class DynamicHeightSearchAdRequest
{
  ...
  {
    zzcrb = Builder.zza(paramBuilder).build();
  }
  
  public <T extends CustomEvent> Bundle getCustomEventExtrasBundle(Class<T> paramClass)
  {
    return zzcrb.getCustomEventExtrasBundle(paramClass);
  }
  
  @Deprecated
  public <T extends NetworkExtras> T getNetworkExtras(Class<T> paramClass)
  {
    return zzcrb.getNetworkExtras(paramClass);
  }
  
  public <T extends MediationAdapter> Bundle getNetworkExtrasBundle(Class<T> paramClass)
  {
    return zzcrb.getNetworkExtrasBundle(paramClass);
  }
  
  public String getQuery()
  {
    return zzcrb.getQuery();
  }
  
  public boolean isTestDevice(Context paramContext)
  {
    return zzcrb.isTestDevice(paramContext);
  }
