...
public final class zzp
{
  ...
  public static boolean zzf(Object paramObject1, Object paramObject2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          bool1 = zzf(((JSONObject)paramObject1).get(str), ((JSONObject)paramObject2).get(str));
          if (!bool1) {
            return false;
          }
        }
      ...
      try
      {
        bool3 = zzf(((JSONArray)paramObject1).get(i), ((JSONArray)paramObject2).get(i));
        bool1 = bool2;
        if (bool3) {
          i += 1;
        }
  ...
  public static String zzib(String paramString)
  {
    ...
    {
      localMatcher = AX.matcher(paramString);
      localObject1 = null;
