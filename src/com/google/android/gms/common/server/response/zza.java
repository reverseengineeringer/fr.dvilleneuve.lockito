  ...
  implements Parcelable.Creator<FastJsonResponse.Field>
{
  static void zza(FastJsonResponse.Field paramField, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 2, paramField.zzatp());
    zzb.zza(paramParcel, 3, paramField.zzatu());
    zzb.zzc(paramParcel, 4, paramField.zzatq());
    zzb.zza(paramParcel, 5, paramField.zzatv());
    zzb.zza(paramParcel, 6, paramField.zzatw(), false);
    zzb.zzc(paramParcel, 7, paramField.zzatx());
    zzb.zza(paramParcel, 8, paramField.zzatz(), false);
    zzb.zza(paramParcel, 9, paramField.zzaub(), paramInt, false);
    zzb.zzaj(paramParcel, i);
  }
  
  public FastJsonResponse.Field zzcr(Parcel paramParcel)
  {
  ...
  public FastJsonResponse.Field[] zzgo(int paramInt)
  {
