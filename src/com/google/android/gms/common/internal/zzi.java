  ...
  implements DialogInterface.OnClickListener
{
  ...
  public static zzi zza(@NonNull Fragment paramFragment, final Intent paramIntent, final int paramInt)
  {
    new zzi()
    {
      public void zzasn()
  ...
  public static zzi zza(@NonNull zzqp paramzzqp, final Intent paramIntent, final int paramInt)
  {
    new zzi()
    {
      @TargetApi(11)
