...
public final class zzag
  extends Button
{
  public zzag(Context paramContext)
  {
    this(paramContext, null);
  }
  
  public zzag(Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  {
    if (paramBoolean) {}
    for (paramInt1 = zzd(paramInt1, zzg(paramInt2, R.drawable.common_plus_signin_btn_icon_dark, R.drawable.common_plus_signin_btn_icon_light, R.drawable.common_plus_signin_btn_icon_dark), zzg(paramInt2, R.drawable.common_plus_signin_btn_text_dark, R.drawable.common_plus_signin_btn_text_light, R.drawable.common_plus_signin_btn_text_dark));; paramInt1 = zzd(paramInt1, zzg(paramInt2, R.drawable.common_google_signin_btn_icon_dark, R.drawable.common_google_signin_btn_icon_light, R.drawable.common_google_signin_btn_icon_light), zzg(paramInt2, R.drawable.common_google_signin_btn_text_dark, R.drawable.common_google_signin_btn_text_light, R.drawable.common_google_signin_btn_text_light)))
    {
  ...
  private boolean zza(Scope[] paramArrayOfScope)
  {
    ...
    for (;;)
    {
      ...
      while (i < j)
      {
        String str = paramArrayOfScope[i].zzaoh();
  ...
  {
    if (paramBoolean) {}
    for (paramInt2 = zzg(paramInt2, R.color.common_plus_signin_btn_text_dark, R.color.common_plus_signin_btn_text_light, R.color.common_plus_signin_btn_text_dark);; paramInt2 = zzg(paramInt2, R.color.common_google_signin_btn_text_dark, R.color.common_google_signin_btn_text_light, R.color.common_google_signin_btn_text_light))
    {
      setTextColor((ColorStateList)zzab.zzaa(paramResources.getColorStateList(paramInt2)));
      switch (paramInt1)
      {
      default: 
