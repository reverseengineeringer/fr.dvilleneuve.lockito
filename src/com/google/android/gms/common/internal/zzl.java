  ...
  implements Handler.Callback
{
  ...
  public boolean isConnectionCallbacksRegistered(GoogleApiClient.ConnectionCallbacks paramConnectionCallbacks)
  {
    ...
    synchronized (zzail)
    {
      boolean bool = yt.contains(paramConnectionCallbacks);
      return bool;
    }
  }
  ...
  public boolean isConnectionFailedListenerRegistered(GoogleApiClient.OnConnectionFailedListener paramOnConnectionFailedListener)
  {
    ...
    synchronized (zzail)
    {
      boolean bool = yv.contains(paramOnConnectionFailedListener);
      return bool;
    }
  }
  ...
  public void unregisterConnectionCallbacks(GoogleApiClient.ConnectionCallbacks paramConnectionCallbacks)
  {
    ...
    synchronized (zzail)
    {
      if (!yt.remove(paramConnectionCallbacks))
      {
      ...
      yu.add(paramConnectionCallbacks);
    }
  }
