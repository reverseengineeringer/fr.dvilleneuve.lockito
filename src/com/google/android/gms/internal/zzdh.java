...
public abstract class zzdh
{
  ...
  {
    public String zzg(@Nullable String paramAnonymousString1, String paramAnonymousString2)
    {
  ...
  {
    @Nullable
    private String zzar(@Nullable String paramAnonymousString)
    {
  ...
  public abstract String zzg(@Nullable String paramString1, String paramString2);
}
