...
public abstract class zzre<T>
{
  ...
  public static zzre<Float> zza(String paramString, Float paramFloat)
  {
    new zzre(paramString, paramFloat)
    {
      protected Float zzhd(String paramAnonymousString)
      {
        return zzre.zzaqx().zzb(zzaxn, (Float)zzaxo);
      }
    };
  }
