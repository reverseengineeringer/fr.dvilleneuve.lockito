  ...
  implements NativeMediationAdRequest
{
  ...
  public zzgy(@Nullable Date paramDate, int paramInt1, @Nullable Set<String> paramSet, @Nullable Location paramLocation, boolean paramBoolean1, int paramInt2, NativeAdOptionsParcel paramNativeAdOptionsParcel, List<String> paramList, boolean paramBoolean2)
  {
    zzfp = paramDate;
    zzaub = paramInt1;
    zzfr = paramSet;
