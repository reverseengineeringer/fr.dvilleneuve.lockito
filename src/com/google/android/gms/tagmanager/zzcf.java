...
class zzcf
  implements zzav
{
  private static final String zzcxz = String.format("CREATE TABLE IF NOT EXISTS %s ( '%s' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, '%s' INTEGER NOT NULL, '%s' TEXT NOT NULL,'%s' INTEGER NOT NULL);", new Object[] { "gtm_hits", "hit_id", "hit_time", "hit_url", "hit_first_send_time" });
  private final zzb awX;
  private volatile zzac awY;
  private final zzaw awZ;
  ...
  zzcf(zzaw paramzzaw, Context paramContext)
  {
    this(paramzzaw, paramContext, "gtm_urls.db", 2000);
  }
  
  zzcf(zzaw paramzzaw, Context paramContext, String paramString, int paramInt)
  {
    mContext = paramContext.getApplicationContext();
    axa = paramString;
    awZ = paramzzaw;
    zzaoa = zzh.zzavi();
    awX = new zzb(mContext, axa);
    awY = new zzde(mContext, new zza());
    axb = 0L;
    axc = paramInt;
  }
  ...
  private void zzcca()
  {
    ...
    if (i > 0)
    {
      List localList = zzyd(i);
      i = localList.size();
      zzbn.v(51 + "Store full, deleting " + i + " hits to make room.");
  ...
  {
    SQLiteDatabase localSQLiteDatabase = zzoa("Error opening database for getNumStoredHits.");
    ...
    {
      zzbn.zzcy(69 + "Error setting HIT_FIRST_DISPATCH_TIME for hitId: " + paramLong1);
      zzs(paramLong1);
    }
  }
  ...
  {
    SQLiteDatabase localSQLiteDatabase = zzoa("Error opening database for putHit");
    if (localSQLiteDatabase == null) {
      return;
    }
    ContentValues localContentValues = new ContentValues();
  ...
  private SQLiteDatabase zzoa(String paramString)
  {
    try
    {
      SQLiteDatabase localSQLiteDatabase = awX.getWritableDatabase();
  ...
  {
    zzg(new String[] { String.valueOf(paramLong) });
  }
  ...
  int zzccb()
  {
    ...
    int i = 0;
    int j = 0;
    Object localObject5 = zzoa("Error opening database for getNumStoredHits.");
    ...
    for (;;)
    {
      ...
      catch (SQLiteException localSQLiteException)
      {
        ...
        zzbn.zzcy("Error getting numStoredHits");
        return 0;
      }
      finally
      {
  ...
  int zzccc()
  {
    ...
    //   3: aload_0
    //   4: ldc -87
    //   6: invokespecial 173	com/google/android/gms/tagmanager/zzcf:zzoa	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   9: astore_3
    //   10: aload_3
    //   11: ifnonnull +5 -> 16
    //   14: iconst_0
    ...
    //   69: astore_3
    //   70: ldc_w 298
    //   73: invokestatic 205	com/google/android/gms/tagmanager/zzbn:zzcy	(Ljava/lang/String;)V
    //   76: aload_3
    //   77: ifnull +56 -> 133
    //   80: aload_3
  ...
  void zzg(String[] paramArrayOfString)
  {
    boolean bool = true;
    ...
    {
      return;
      localSQLiteDatabase = zzoa("Error opening database for deleteHits.");
    ...
    for (;;)
    {
      try
      {
        ...
        paramArrayOfString = awZ;
        if (zzccb() == 0)
        {
          paramArrayOfString.zzcg(bool);
          return;
        }
      }
      catch (SQLiteException paramArrayOfString)
      {
        zzbn.zzcy("Error deleting hits");
        return;
      }
      bool = false;
    }
  ...
  List<String> zzyd(int paramInt)
  {
    ...
    //   10: ifgt +12 -> 22
    //   13: ldc_w 336
    //   16: invokestatic 205	com/google/android/gms/tagmanager/zzbn:zzcy	(Ljava/lang/String;)V
    //   19: aload 6
    //   21: areturn
    //   22: aload_0
    //   23: ldc_w 338
    //   26: invokespecial 173	com/google/android/gms/tagmanager/zzcf:zzoa	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   29: astore_3
    //   30: aload_3
    //   31: ifnonnull +6 -> 37
    //   34: aload 6
    ...
    //   52: astore 4
    //   54: iload_1
    //   55: invokestatic 343	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   58: astore 5
    //   60: aload_3
    //   61: ldc 35
    //   63: iconst_1
    ...
    //   76: aload 4
    //   78: aload 5
    //   80: invokevirtual 346	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   83: astore 4
    //   85: aload 4
    //   87: astore_3
    //   88: aload 4
    ...
    //   157: astore_3
    //   158: aload 5
    //   160: invokevirtual 356	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    //   163: invokestatic 359	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   166: astore 5
    //   168: aload 4
    //   170: astore_3
    //   171: aload 5
    //   173: invokevirtual 362	java/lang/String:length	()I
    //   176: ifeq +39 -> 215
    //   179: aload 4
    //   181: astore_3
    //   182: ldc_w 364
    //   185: aload 5
    //   187: invokevirtual 368	java/lang/String:concat	(Ljava/lang/String;)Ljava/lang/String;
    //   190: astore 5
    //   192: aload 4
    //   194: astore_3
    //   195: aload 5
    //   197: invokestatic 205	com/google/android/gms/tagmanager/zzbn:zzcy	(Ljava/lang/String;)V
    //   200: aload 4
    //   202: ifnull -55 -> 147
    //   205: aload 4
    ...
    //   221: dup
    //   222: ldc_w 364
    //   225: invokespecial 370	java/lang/String:<init>	(Ljava/lang/String;)V
    //   228: astore 5
    //   230: goto -38 -> 192
    //   233: astore 5
    //   235: aload_3
  ...
  /* Error */
  public List<zzar> zzye(int paramInt)
  {
    // Byte code:
    //   0: new 333	java/util/ArrayList
    //   3: dup
    ...
    //   9: aload_0
    //   10: ldc_w 374
    //   13: invokespecial 173	com/google/android/gms/tagmanager/zzcf:zzoa	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   16: astore 8
    //   18: aload 8
    //   20: ifnonnull +10 -> 30
    //   23: aload 5
    ...
    //   48: astore 4
    //   50: iload_1
    //   51: invokestatic 343	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   54: astore 7
    //   56: aload 8
    //   58: ldc 35
    //   60: iconst_3
    ...
    //   83: aload 4
    //   85: aload 7
    //   87: invokevirtual 346	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   90: astore 4
    //   92: new 333	java/util/ArrayList
    //   95: dup
    //   96: invokespecial 334	java/util/ArrayList:<init>	()V
    //   99: astore 7
    //   101: aload 4
    //   103: invokeinterface 278 1 0
    //   108: ifeq +54 -> 162
    //   111: aload 7
    //   113: new 376	com/google/android/gms/tagmanager/zzar
    //   116: dup
    //   117: aload 4
    //   119: iconst_0
    ...
    //   141: invokespecial 379	com/google/android/gms/tagmanager/zzar:<init>	(JJJ)V
    //   144: invokeinterface 350 2 0
    //   149: pop
    //   150: aload 4
    //   152: invokeinterface 353 1 0
    //   157: istore_3
    //   158: iload_3
    //   159: ifne -48 -> 111
    //   162: aload 4
    ...
    //   197: astore 5
    //   199: iload_1
    //   200: invokestatic 343	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   203: astore 9
    //   205: aload 4
    //   207: astore 5
    //   209: aload 8
    ...
    //   231: aload 6
    //   233: aload 9
    //   235: invokevirtual 346	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   238: astore 6
    //   240: aload 6
    ...
    //   251: istore_1
    //   252: aload 6
    //   254: checkcast 381	android/database/sqlite/SQLiteCursor
    //   257: invokevirtual 385	android/database/sqlite/SQLiteCursor:getWindow	()Landroid/database/CursorWindow;
    //   260: invokevirtual 390	android/database/CursorWindow:getNumRows	()I
    //   263: ifle +149 -> 412
    //   266: aload 7
    //   268: iload_1
    //   269: invokeinterface 394 2 0
    //   274: checkcast 376	com/google/android/gms/tagmanager/zzar
    //   277: aload 6
    //   279: iconst_1
    //   280: invokeinterface 397 2 0
    //   285: invokevirtual 400	com/google/android/gms/tagmanager/zzar:zzoe	(Ljava/lang/String;)V
    //   288: aload 6
    //   290: invokeinterface 353 1 0
    //   295: istore_3
    //   296: iload_3
    //   297: ifne +429 -> 726
    //   300: aload 6
    ...
    //   326: astore 5
    //   328: aload 6
    //   330: invokevirtual 356	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    //   333: invokestatic 359	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   336: astore 6
    //   338: aload 6
    //   340: invokevirtual 362	java/lang/String:length	()I
    //   343: ifeq +37 -> 380
    //   346: ldc_w 364
    //   349: aload 6
    //   351: invokevirtual 368	java/lang/String:concat	(Ljava/lang/String;)Ljava/lang/String;
    //   354: astore 6
    //   356: aload 6
    //   358: invokestatic 205	com/google/android/gms/tagmanager/zzbn:zzcy	(Ljava/lang/String;)V
    //   361: aload 4
    //   363: astore 6
    //   365: aload 5
    //   367: ifnull -340 -> 27
    ...
    //   383: dup
    //   384: ldc_w 364
    //   387: invokespecial 370	java/lang/String:<init>	(Ljava/lang/String;)V
    //   390: astore 6
    //   392: goto -36 -> 356
    //   395: astore 4
    //   397: aload 5
    ...
    //   421: aload 7
    //   423: iload_1
    //   424: invokeinterface 394 2 0
    //   429: checkcast 376	com/google/android/gms/tagmanager/zzar
    //   432: invokevirtual 406	com/google/android/gms/tagmanager/zzar:zzcbn	()J
    //   435: invokestatic 182	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   438: aastore
    //   439: invokestatic 49	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   442: invokestatic 205	com/google/android/gms/tagmanager/zzbn:zzcy	(Ljava/lang/String;)V
    //   445: goto -157 -> 288
    //   448: astore 5
    //   450: aload 6
    //   452: astore 4
    ...
    //   460: astore 5
    //   462: aload 6
    //   464: invokevirtual 356	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    //   467: invokestatic 359	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   470: astore 6
    //   472: aload 4
    //   474: astore 5
    //   476: aload 6
    //   478: invokevirtual 362	java/lang/String:length	()I
    //   481: ifeq +122 -> 603
    //   484: aload 4
    //   486: astore 5
    //   488: ldc_w 408
    //   491: aload 6
    //   493: invokevirtual 368	java/lang/String:concat	(Ljava/lang/String;)Ljava/lang/String;
    //   496: astore 6
    //   498: aload 4
    //   500: astore 5
    //   502: aload 6
    //   504: invokestatic 205	com/google/android/gms/tagmanager/zzbn:zzcy	(Ljava/lang/String;)V
    //   507: aload 4
    //   509: astore 5
    //   511: new 333	java/util/ArrayList
    //   514: dup
    //   515: invokespecial 334	java/util/ArrayList:<init>	()V
    //   518: astore 6
    //   520: iconst_0
    //   521: istore_1
    //   522: aload 4
    ...
    //   537: astore 5
    //   539: aload 7
    //   541: invokeinterface 417 1 0
    //   546: ifeq +42 -> 588
    //   549: aload 4
    //   551: astore 5
    //   553: aload 7
    //   555: invokeinterface 421 1 0
    //   560: checkcast 376	com/google/android/gms/tagmanager/zzar
    //   563: astore 8
    //   565: aload 4
    //   567: astore 5
    //   569: aload 8
    //   571: invokevirtual 424	com/google/android/gms/tagmanager/zzar:zzcbp	()Ljava/lang/String;
    //   574: invokestatic 427	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   577: istore_3
    //   578: iload_1
    //   579: istore_2
    //   580: iload_3
    ...
    //   610: dup
    //   611: ldc_w 408
    //   614: invokespecial 370	java/lang/String:<init>	(Ljava/lang/String;)V
    //   617: astore 6
    //   619: goto -121 -> 498
    //   622: astore 4
    //   624: aload 5
  ...
  int zzzy()
  {
    ...
    do
    {
      return 0;
      axb = l;
      localObject = zzoa("Error opening database for deleteStaleHits.");
    } while (localObject == null);
    int i = ((SQLiteDatabase)localObject).delete("gtm_hits", "HIT_TIME < ?", new String[] { Long.toString(zzaoa.currentTimeMillis() - 2592000000L) });
    Object localObject = awZ;
    if (zzccb() == 0) {}
    for (;;)
    {
      ((zzaw)localObject).zzcg(bool);
      return i;
      bool = false;
    }
  }
    ...
    implements zzde.zza
  {
    ...
    {
      zzcf.zza(zzcf.this, paramzzar.zzcbn());
    }
    ...
    public void zzc(zzar paramzzar)
    {
      ...
      if (l == 0L) {
        zzcf.zza(zzcf.this, paramzzar.zzcbn(), zzcf.zza(zzcf.this).currentTimeMillis());
      }
      while (l + 14400000L >= zzcf.zza(zzcf.this).currentTimeMillis()) {
        return;
      }
      zzcf.zza(zzcf.this, paramzzar.zzcbn());
      l = paramzzar.zzcbn();
    ...
    extends SQLiteOpenHelper
  {
    ...
    {
      if ((axe) && (axf + 3600000L > zzcf.zza(zzcf.this).currentTimeMillis())) {
        throw new SQLiteException("Database creation failed");
      }
      Object localObject1 = null;
      axe = true;
      axf = zzcf.zza(zzcf.this).currentTimeMillis();
      try
      {
