...
class zzh
  extends zzal
{
  private static final String ID = zzaf.zzgf.toString();
  ...
  public zzai.zza zzav(Map<String, zzai.zza> paramMap)
  {
    try
    {
      paramMap = zzdl.zzar(Integer.valueOf(mContext.getPackageManager().getPackageInfo(mContext.getPackageName(), 0).versionCode));
      return paramMap;
    }
