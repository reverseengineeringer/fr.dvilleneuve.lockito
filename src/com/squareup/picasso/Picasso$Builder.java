...
public class Picasso$Builder
{
  ...
  public Picasso build()
  {
    ...
    return new Picasso(localContext, new Dispatcher(localContext, service, Picasso.HANDLER, downloader, cache, localStats), cache, listener, transformer, localStats, debugging);
  }
