...
public class Dumper
{
  ...
  public Dumper(Iterable<DumperPlugin> paramIterable, CommandLineParser paramCommandLineParser)
  {
    ...
    mParser = paramCommandLineParser;
  ...
  {
    paramArrayOfString = mParser.parse(mGlobalOptions.options, paramArrayOfString, true);
    if (paramArrayOfString.hasOption(mGlobalOptions.optionHelp.getOpt()))
    {
      dumpUsage(paramPrintStream1);
      return 0;
    }
    if (paramArrayOfString.hasOption(mGlobalOptions.optionListPlugins.getOpt()))
    {
  ...
  private void dumpUsage(PrintStream paramPrintStream)
  {
    ...
    try
    {
      localHelpFormatter.printOptions(paramPrintStream, localHelpFormatter.getWidth(), mGlobalOptions.options, localHelpFormatter.getLeftPadding(), localHelpFormatter.getDescPadding());
      return;
    }
    finally
    {
