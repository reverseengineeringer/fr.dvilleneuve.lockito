  ...
  extends AbstractChainedDescriptor<TextView>
{
  ...
  protected void onHook(TextView paramTextView)
  {
    ...
    mElementToContextMap.put(paramTextView, localElementContext);
  }
  
  protected void onUnhook(TextView paramTextView)
  {
    ((ElementContext)mElementToContextMap.remove(paramTextView)).unhook();
  }
    ...
    implements TextWatcher
  {
    ...
    public void afterTextChanged(Editable paramEditable)
    {
      ...
      {
        getHost().onAttributeRemoved(mElement, "text");
        return;
      }
      getHost().onAttributeModified(mElement, "text", paramEditable.toString());
    }
