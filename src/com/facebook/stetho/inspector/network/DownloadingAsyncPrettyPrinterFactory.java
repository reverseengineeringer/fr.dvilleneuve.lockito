  ...
  implements AsyncPrettyPrinterFactory
{
  ...
  private static AsyncPrettyPrinter getErrorAsyncPrettyPrinter(String paramString1, final String paramString2)
  {
    new AsyncPrettyPrinter()
    {
      ...
      public void printTo(PrintWriter paramAnonymousPrintWriter, InputStream paramAnonymousInputStream)
        throws IOException
      {
        DownloadingAsyncPrettyPrinterFactory.doErrorPrint(paramAnonymousPrintWriter, paramAnonymousInputStream, "[Failed to parse header: " + val$headerName + " : " + paramString2 + " ]");
      }
    };
  }
    ...
    new AsyncPrettyPrinter()
    {
        ...
        throws IOException
      {
        ...
        catch (ExecutionException localExecutionException)
        {
          try
          {
            doPrint(paramAnonymousPrintWriter, paramAnonymousInputStream, str);
            return;
          }
  ...
  protected class MatchResult
  {
    ...
    {
      mSchemaUri = paramString;
      mDisplayType = paramPrettyPrinterDisplayType;
    }
