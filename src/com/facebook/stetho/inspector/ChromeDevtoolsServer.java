  ...
  implements SimpleEndpoint
{
    ...
    throws MessageHandlingException
  {
    ...
    try
    {
      localObject2 = mMethodDispatcher.dispatch(paramJsonRpcPeer, method, params);
    ...
    catch (JsonRpcException paramJSONObject)
    {
      ...
      catch (OutOfMemoryError paramJSONObject)
      {
        for (;;)
        {
          Object localObject2;
          result = null;
          error = ((JSONObject)mObjectMapper.convertValue(paramJSONObject.getMessage(), JSONObject.class));
          paramJSONObject = ((JSONObject)mObjectMapper.convertValue(localObject2, JSONObject.class)).toString();
        }
      }
    }
    if (id != null)
    {
      ...
      id = id.longValue();
      result = ((JSONObject)localObject1);
      error = paramJSONObject;
      paramJSONObject = (JSONObject)mObjectMapper.convertValue(localObject2, JSONObject.class);
    }
  }
