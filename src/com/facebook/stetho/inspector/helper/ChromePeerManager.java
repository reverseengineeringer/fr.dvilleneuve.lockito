...
public class ChromePeerManager
{
  ...
  private JsonRpcPeer[] getReceivingPeersSnapshot()
  {
    try
    {
      if (mReceivingPeersSnapshot == null) {
        mReceivingPeersSnapshot = ((JsonRpcPeer[])mReceivingPeers.keySet().toArray(new JsonRpcPeer[mReceivingPeers.size()]));
      }
      JsonRpcPeer[] arrayOfJsonRpcPeer = mReceivingPeersSnapshot;
  ...
  public void removePeer(JsonRpcPeer paramJsonRpcPeer)
  {
    try
    {
      if (mReceivingPeers.remove(paramJsonRpcPeer) != null)
      {
