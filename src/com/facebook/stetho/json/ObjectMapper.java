...
public class ObjectMapper
{
    ...
    throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException, JSONException
  {
    ...
    while (i < arrayOfField.length)
    {
      ...
      Object localObject3 = paramJSONObject.opt(localConstructor.getName());
      Object localObject1 = getValueForField(localConstructor, localObject3);
      try
      {
        localConstructor.set(localObject2, getValueForField(localConstructor, localObject3));
        i += 1;
      }
    ...
    throws InvocationTargetException, IllegalAccessException
  {
    ...
    } while (canDirectlySerializeClass(paramClass));
