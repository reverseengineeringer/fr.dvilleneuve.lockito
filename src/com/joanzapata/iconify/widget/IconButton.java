  ...
  implements HasOnViewAttachListener
{
  ...
  public IconButton(Context paramContext)
  {
    super(paramContext);
    init();
  }
  
  public IconButton(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    init();
  }
  
  public IconButton(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
...
/* Location:
 * Qualified Name:     com.joanzapata.iconify.widget.IconButton
