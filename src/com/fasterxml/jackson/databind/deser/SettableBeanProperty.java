  ...
  implements BeanProperty, Serializable
{
  ...
  protected SettableBeanProperty(SettableBeanProperty paramSettableBeanProperty, JsonDeserializer<?> paramJsonDeserializer)
  {
    ...
    for (;;)
    {
      _nullProvider = localNullProvider;
      _valueDeserializer = paramJsonDeserializer;
      break;
      localNullProvider = new NullProvider(_type, localObject);
    }
  }
  ...
  {
    this(new PropertyName(paramString), paramJavaType, paramPropertyName, paramTypeDeserializer, paramAnnotations, PropertyMetadata.STD_OPTIONAL);
  }
  ...
  {
    this(new PropertyName(paramString), paramJavaType, paramPropertyName, paramTypeDeserializer, paramAnnotations, PropertyMetadata.construct(paramBoolean, null));
  }
