  ...
  implements Serializable
{
  ...
  {
    this(paramJavaType, new PropertyName(paramString), paramObjectIdGenerator, paramJsonDeserializer, paramSettableBeanProperty);
  }
  ...
  {
    return new ObjectIdReader(paramJavaType, paramPropertyName, paramObjectIdGenerator, paramJsonDeserializer, paramSettableBeanProperty);
  }
  ...
  {
    return construct(paramJavaType, new PropertyName(paramString), paramObjectIdGenerator, paramJsonDeserializer, paramSettableBeanProperty);
  }
