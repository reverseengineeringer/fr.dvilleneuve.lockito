  ...
  implements Serializable
{
  ...
  {
    Object localObject2 = _primary.findContentDeserializer(paramAnnotated);
    Object localObject1;
    if ((localObject2 != null) && (localObject2 != JsonDeserializer.None.class))
    {
      localObject1 = localObject2;
      if (localObject2 != NoClass.class) {}
    }
    else
    {
      localObject1 = _secondary.findContentDeserializer(paramAnnotated);
    }
    return localObject1;
  }
  ...
  {
    Object localObject2 = _primary.findContentSerializer(paramAnnotated);
    Object localObject1;
    if ((localObject2 != null) && (localObject2 != JsonSerializer.None.class))
    {
      localObject1 = localObject2;
      if (localObject2 != NoClass.class) {}
    }
    ...
    {
      localObject1 = _secondary.findContentSerializer(paramAnnotated);
    }
    return localObject1;
  }
  ...
  {
    String str2 = _primary.findDeserializationName(paramAnnotatedField);
    if (str2 == null) {
      paramAnnotatedField = _secondary.findDeserializationName(paramAnnotatedField);
    }
    String str1;
    do
    {
      ...
      str1 = _secondary.findDeserializationName(paramAnnotatedField);
  ...
  {
    String str2 = _primary.findDeserializationName(paramAnnotatedMethod);
    if (str2 == null) {
      paramAnnotatedMethod = _secondary.findDeserializationName(paramAnnotatedMethod);
    }
    String str1;
    do
    {
      ...
      str1 = _secondary.findDeserializationName(paramAnnotatedMethod);
  ...
  {
    String str2 = _primary.findDeserializationName(paramAnnotatedParameter);
    String str1 = str2;
    if (str2 == null) {
      str1 = _secondary.findDeserializationName(paramAnnotatedParameter);
    }
    return str1;
  }
  ...
  {
    Class localClass2 = _primary.findDeserializationType(paramAnnotated, paramJavaType);
    Class localClass1 = localClass2;
    if (localClass2 == null) {
      localClass1 = _secondary.findDeserializationType(paramAnnotated, paramJavaType);
    }
    return localClass1;
  }
  ...
  {
    Object localObject2 = _primary.findKeyDeserializer(paramAnnotated);
    Object localObject1;
    if ((localObject2 != null) && (localObject2 != KeyDeserializer.None.class))
    {
      localObject1 = localObject2;
      if (localObject2 != NoClass.class) {}
    }
    ...
    {
      localObject1 = _secondary.findKeyDeserializer(paramAnnotated);
    }
    return localObject1;
  }
  ...
  {
    Object localObject2 = _primary.findKeySerializer(paramAnnotated);
    Object localObject1;
    if ((localObject2 != null) && (localObject2 != JsonSerializer.None.class))
    {
      localObject1 = localObject2;
    ...
    {
      localObject1 = _secondary.findKeySerializer(paramAnnotated);
    }
    return localObject1;
  }
  ...
  {
    Object localObject2 = _primary.findNullSerializer(paramAnnotated);
    Object localObject1;
    if ((localObject2 != null) && (localObject2 != JsonSerializer.None.class))
    {
      localObject1 = localObject2;
    ...
    {
      localObject1 = _secondary.findNullSerializer(paramAnnotated);
    }
    return localObject1;
  }
  ...
  {
    String str2 = _primary.findSerializationName(paramAnnotatedField);
    if (str2 == null) {
      paramAnnotatedField = _secondary.findSerializationName(paramAnnotatedField);
    }
    String str1;
    do
    {
      ...
      str1 = _secondary.findSerializationName(paramAnnotatedField);
      paramAnnotatedField = str1;
    } while (str1 != null);
    return str2;
  }
  ...
  {
    String str2 = _primary.findSerializationName(paramAnnotatedMethod);
    if (str2 == null) {
      paramAnnotatedMethod = _secondary.findSerializationName(paramAnnotatedMethod);
    }
    String str1;
    do
    {
      ...
      str1 = _secondary.findSerializationName(paramAnnotatedMethod);
      paramAnnotatedMethod = str1;
    } while (str1 != null);
    return str2;
  }
