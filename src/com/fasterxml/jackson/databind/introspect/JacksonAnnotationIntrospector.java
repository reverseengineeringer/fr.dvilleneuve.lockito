  ...
  implements Serializable
{
  ...
  public Object findDeserializationContentConverter(AnnotatedMember paramAnnotatedMember)
  {
    ...
    {
      paramAnnotatedMember = paramAnnotatedMember.contentConverter();
      if (paramAnnotatedMember != Converter.None.class) {
  ...
  public Object findDeserializationConverter(Annotated paramAnnotated)
  {
    ...
    if (paramAnnotated != null)
    {
      paramAnnotated = paramAnnotated.converter();
      if (paramAnnotated != Converter.None.class) {
        return paramAnnotated;
      }
    }
    return null;
  ...
  public ObjectIdInfo findObjectIdInfo(Annotated paramAnnotated)
  {
    ...
    return new ObjectIdInfo(new PropertyName(paramAnnotated.property()), paramAnnotated.scope(), paramAnnotated.generator());
  }
