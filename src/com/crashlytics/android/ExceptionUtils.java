...
final class ExceptionUtils
{
  ...
  public static void writeStackTrace(android.content.Context paramContext, Throwable paramThrowable, String paramString)
  {
    ...
    //   19: aload_1
    //   20: aload_0
    //   21: invokestatic 45	com/crashlytics/android/ExceptionUtils:writeStackTrace	(Ljava/lang/Throwable;Ljava/io/Writer;)V
    //   24: aload_0
    //   25: ldc 47
  ...
  private static void writeStackTrace(Throwable paramThrowable, OutputStream paramOutputStream)
  {
    ...
    //   13: aload_0
    //   14: aload_1
    //   15: invokestatic 45	com/crashlytics/android/ExceptionUtils:writeStackTrace	(Ljava/lang/Throwable;Ljava/io/Writer;)V
    //   18: aload_1
    //   19: ldc 47
  ...
  private static void writeStackTrace(Throwable paramThrowable, Writer paramWriter)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramThrowable)
      {
        int j;
        int k;
        Fabric.getLogger().e("Fabric", "Could not write stack trace", paramThrowable);
      }
