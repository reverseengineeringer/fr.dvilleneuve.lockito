  ...
  implements NotificationCompat.Extender
{
  ...
  public NotificationCompat$WearableExtender(Notification paramNotification)
  {
    ...
    for (paramNotification = paramNotification.getBundle("android.wearable.EXTENSIONS");; paramNotification = null)
    {
      if (paramNotification != null)
      {
        Object localObject = NotificationCompat.access$300().getActionsFromParcelableArrayList(paramNotification.getParcelableArrayList("actions"));
        if (localObject != null) {
        ...
        localObject = NotificationCompat.access$600(paramNotification, "pages");
        if (localObject != null) {
  ...
  public NotificationCompat.Builder extend(NotificationCompat.Builder paramBuilder)
  {
    ...
    if (!mActions.isEmpty()) {
      localBundle.putParcelableArrayList("actions", NotificationCompat.access$300().getParcelableArrayListForActions((NotificationCompat.Action[])mActions.toArray(new NotificationCompat.Action[mActions.size()])));
    }
    if (mFlags != 1) {
