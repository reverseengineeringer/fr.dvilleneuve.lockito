  ...
  implements ViewTreeObserver.OnPreDrawListener
{
  ...
  public boolean onPreDraw()
  {
    ...
    if (val$enterTransition != null)
    {
      ...
      FragmentTransitionCompat21.access$100(val$enterTransition, val$exitTransition, val$exitingViews, false);
      FragmentTransitionCompat21.access$100(val$enterTransition, val$sharedElementTransition, val$sharedElementTargets, false);
    }
    if (val$exitTransition != null)
    {
      FragmentTransitionCompat21.removeTargets(val$exitTransition, val$exitingViews);
      FragmentTransitionCompat21.access$100(val$exitTransition, val$enterTransition, val$enteringViews, false);
      FragmentTransitionCompat21.access$100(val$exitTransition, val$sharedElementTransition, val$sharedElementTargets, false);
    }
