  ...
  extends NotificationCompatBase.Action
{
  ...
  private NotificationCompat$Action(int paramInt, CharSequence paramCharSequence, PendingIntent paramPendingIntent, Bundle paramBundle, RemoteInput[] paramArrayOfRemoteInput, boolean paramBoolean)
  {
    icon = paramInt;
  ...
  public static final class Builder
  {
    ...
    public NotificationCompat.Action build()
    {
      ...
      for (RemoteInput[] arrayOfRemoteInput = (RemoteInput[])mRemoteInputs.toArray(new RemoteInput[mRemoteInputs.size()]);; arrayOfRemoteInput = null) {
        return new NotificationCompat.Action(mIcon, mTitle, mIntent, mExtras, arrayOfRemoteInput, mAllowGeneratedReplies, null);
      }
    }
