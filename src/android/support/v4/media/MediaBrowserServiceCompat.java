            ...
            if (localObject2 != null)
            {
              ...
              while (((Iterator)localObject2).hasNext())
              {
                ...
                if (MediaBrowserCompatUtils.hasDuplicatedItems(paramBundle, (Bundle)second)) {
                  MediaBrowserServiceCompat.this.performLoadChildren(paramString, (MediaBrowserServiceCompat.ConnectionRecord)localObject1, (Bundle)second);
                }
              }
            }
          }
