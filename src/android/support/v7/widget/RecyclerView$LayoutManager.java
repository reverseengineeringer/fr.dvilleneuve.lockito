...
public abstract class RecyclerView$LayoutManager
{
  ...
  {
    return (mRecyclerView != null) && (RecyclerView.access$5400(mRecyclerView));
  }
  ...
  public void getTransformedBoundingBox(View paramView, boolean paramBoolean, Rect paramRect)
  {
    ...
    for (;;)
    {
      if (mRecyclerView != null)
      {
        ...
        {
          RectF localRectF = RecyclerView.access$5500(mRecyclerView);
  ...
  void setMeasuredDimensionFromChildren(int paramInt1, int paramInt2)
  {
    ...
    while (k < i3)
    {
      ...
      localObject = RecyclerView.access$5300(mRecyclerView);
    ...
    RecyclerView.access$5300(mRecyclerView).set(i1, j, n, i);
    setMeasuredDimension(RecyclerView.access$5300(mRecyclerView), paramInt1, paramInt2);
  }
