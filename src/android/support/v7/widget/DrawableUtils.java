...
public class DrawableUtils
{
  ...
  {
    if ((Build.VERSION.SDK_INT < 8) && ((paramDrawable instanceof StateListDrawable))) {}
    while (((Build.VERSION.SDK_INT < 15) && ((paramDrawable instanceof InsetDrawable))) || ((Build.VERSION.SDK_INT < 15) && ((paramDrawable instanceof GradientDrawable))) || ((Build.VERSION.SDK_INT < 17) && ((paramDrawable instanceof LayerDrawable)))) {
      return false;
    }
