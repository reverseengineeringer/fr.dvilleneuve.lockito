...
public final class RecyclerView$Recycler
{
  ...
  private void attachAccessibilityDelegate(View paramView)
  {
    if (this$0.isAccessibilityEnabled())
    {
      ...
      if (!ViewCompat.hasAccessibilityDelegate(paramView)) {
        ViewCompat.setAccessibilityDelegate(paramView, RecyclerView.access$4700(this$0).getItemDelegate());
      }
    }
  }
  ...
  {
    if (RecyclerView.access$5200(this$0) != null) {
      RecyclerView.access$5200(this$0).onViewRecycled(paramViewHolder);
    }
  ...
  View getViewForPosition(int paramInt, boolean paramBoolean)
  {
    ...
    if ((k != 0) && (!this$0.mState.isPreLayout()) && (((RecyclerView.ViewHolder)localObject2).hasAnyOfTheFlags(8192)))
    {
      ...
      if (RecyclerView.State.access$2500(this$0.mState))
      {
        ...
        RecyclerView.access$4600(this$0, (RecyclerView.ViewHolder)localObject2, (RecyclerView.ItemAnimator.ItemHolderInfo)localObject1);
      }
    }
    int i = 0;
  ...
  {
    paramView = RecyclerView.getChildViewHolderInt(paramView);
    if ((paramView.hasAnyOfTheFlags(12)) || (!paramView.isUpdated()) || (RecyclerView.access$5100(this$0, paramView)))
    {
