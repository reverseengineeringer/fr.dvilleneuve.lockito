  ...
  implements ScrollingView, NestedScrollingChild
{
  ...
  public RecyclerView(Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    {
      Object localObject = paramContext.obtainStyledAttributes(paramAttributeSet, CLIP_TO_PADDING_ATTR, paramInt, 0);
  ...
  private void recoverFocusFromState()
  {
    ...
    do
    {
      ...
      } while ((localObject1 == null) || (!mChildHelper.isHidden((View)localObject1)));
      localObject1 = null;
      if (mState.mFocusedItemPosition != -1) {
        localObject1 = findViewHolderForAdapterPosition(mState.mFocusedItemPosition);
      }
      ...
      if (localObject1 == null)
      {
        ...
        if (mState.mFocusedItemId != -1L)
        {
          ...
          if (mAdapter.hasStableIds()) {
            localObject2 = findViewHolderForItemId(mState.mFocusedItemId);
          }
        }
      }
    } while ((localObject2 == null) || (itemView.hasFocus()) || (!itemView.hasFocusable()));
    View localView = itemView;
    Object localObject1 = localView;
    if (mState.mFocusedSubChildId != -1L)
    {
      localObject2 = itemView.findViewById(mState.mFocusedSubChildId);
  ...
  private void saveFocusInfo()
  {
    ...
    label144:
    for (int i = -1;; i = ((ViewHolder)localObject).getAdapterPosition())
    {
  ...
  public View focusSearch(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      if (j != 0)
      {
        ...
        eatRequestLayout();
        mLayout.onFocusSearchFailed(paramView, paramInt, mRecycler, mState);
        resumeRequestLayout(false);
      }
    }
  ...
  public static abstract class LayoutManager
  {
    ...
    void setMeasuredDimensionFromChildren(int paramInt1, int paramInt2)
    {
      ...
      while (k < i3)
      {
        ...
        localObject = mRecyclerView.mTempRect;
  ...
  public final class Recycler
  {
    ...
    {
      paramView = RecyclerView.getChildViewHolderInt(paramView);
      RecyclerView.ViewHolder.access$4902(paramView, null);
      RecyclerView.ViewHolder.access$5002(paramView, false);
    ...
    void recycleViewHolderInternal(RecyclerView.ViewHolder paramViewHolder)
    {
      ...
      bool = RecyclerView.ViewHolder.access$4800(paramViewHolder);
    ...
    {
      if (RecyclerView.ViewHolder.access$5000(paramViewHolder)) {
        mChangedScrap.remove(paramViewHolder);
      }
      for (;;)
      {
        RecyclerView.ViewHolder.access$4902(paramViewHolder, null);
        RecyclerView.ViewHolder.access$5002(paramViewHolder, false);
