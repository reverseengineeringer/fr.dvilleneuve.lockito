  ...
  implements DialogInterface
{
  ...
  private final AlertController mAlert = new AlertController(getContext(), this, getWindow());
  ...
  private static int resolveDialogTheme(@NonNull Context paramContext, @StyleRes int paramInt)
  {
