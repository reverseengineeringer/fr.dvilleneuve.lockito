...
public class AlertDialog$Builder
{
  ...
  {
    this(paramContext, AlertDialog.access$000(paramContext, 0));
  }
  
  public AlertDialog$Builder(@NonNull Context paramContext, @StyleRes int paramInt)
  {
    P = new AlertController.AlertParams(new ContextThemeWrapper(paramContext, AlertDialog.access$000(paramContext, paramInt)));
    mTheme = paramInt;
  }
  ...
  public AlertDialog create()
  {
    ...
    P.apply(AlertDialog.access$100(localAlertDialog));
